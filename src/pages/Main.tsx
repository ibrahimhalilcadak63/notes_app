...
const Main = ({ availableTags, notes }: Props) => {
   ...
   * 2) 2.input ile seçilen etiketler note'un içerisindeki etiketler ile birebir eşleşmelidir. Seçilen etiketler dizindeki her bir etiket için note'a ait etiketler arasında eşleşme kontrolü yapılır.
  ...
  */
  ...
  return (
    <Container className="mx-auto py-5">
      {/* Üst Bölüm, logo, başlık ve oluştur butonu bölümü*/}
